...
description: Generate Nano Banana Pro style JSON prompts from text or image references for Claude tool automation. Use when a user provides a prompt, a local image path, or an image URL and needs a structured JSON prompt with dynamic fields, constraints/negative_prompt, and a short explanation.
---
